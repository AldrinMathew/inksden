...
export declare function PaddingSymmetric(symmetry: SymmetryInterface): Padding;
export declare function PaddingAll(value: number): Padding;
export declare function PaddingVertical(value: number): Padding;
export declare function PaddingHorizontal(value: number): Padding;
export declare function PaddingOnly(side: SideInterface): Padding;
export declare function PaddingZero(): Padding;
