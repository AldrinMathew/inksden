...
export declare function MarginSymmetric(horizontal: number, vertical: number): Margin;
export declare function MarginAll(value: number): Margin;
export declare function MarginVertical(value: number): Margin;
export declare function MarginHorizontal(value: number): Margin;
export declare function MarginOnly(top?: number, left?: number, right?: number, bottom?: number): Margin;
export declare function MarginZero(): Margin;
